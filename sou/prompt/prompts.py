...
def get_hard_question_instruction(Challenge: str):
    return (
        ...
        "return result\n\n"
        "Assistant:\n"
        f"{CODING_QUERY_BEGIN} Write a Python function p_f_interval(reliability: callable, t: float, delta_t: float) -> float that:\n"
        "Calculates 1 - reliability(t)\n"
        "Calculates reliability(t + delta_t)\n"
        f"Returns the sum of these two quantities. Make sure to import numpy as np. {CODING_QUERY_END}\n\n"
        "Remember:\n"
        f"- Use {KNOWLEDGE_QUERY_BEGIN} to ask a question to the expert agent, and end with {KNOWLEDGE_QUERY_END}.\n"
        f"- Use {CODING_QUERY_BEGIN} to deliver your final answer, which should be pseudocode, and end with {CODING_QUERY_END}.\n"
